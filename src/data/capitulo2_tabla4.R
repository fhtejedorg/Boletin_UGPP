...
ggsave(filename = '../figures/Capitulo_2_2/total_novedades_dependientes_1.png',
              width = 10, height = 6,
...
salida_dependientes_novedades_resto %>%
  gtsave("salida_dependientes_novedades_resto.png", path = '../results/Cotizantes_Novedades')
...
salida_dependientes_novedades_resto_comparativo %>%
  gtsave("salida_dependientes_novedades_resto_comparativo.png", path = '../results/Cotizantes_Novedades')
...
ggsave(filename = '../figures/Capitulo_2_2/total_novedades_independientes_1.png', 
